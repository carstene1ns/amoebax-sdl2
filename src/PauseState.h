...
namespace Amoebax
{
    ...
    class PauseState: public IState
    {
        ...
        private:
            ...
            ///
            /// \class ContinueOption.
            /// \brief Continue game option.
            ///
            class ContinueOption: public IOption
            {
                public:
                    ///
                    /// \brief Default constructor.
                    ...
                    ///
                    ContinueOption (const std::string &title): IOption (title) { }
                    virtual void operator() (void);
            };

            ///
            /// \class ExitOption.
            /// \brief Exit to main menu option.
            ///

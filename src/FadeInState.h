...
//
#if !defined (AMOEBAX_FADE_IN_STATE_H)
#define AMOEBAX_FADE_IN_STATE_H
...
namespace Amoebax
{
    ///
    /// \class FadeInState
    /// \brief Fades the screen from black to its contents.
    ///
    class FadeInState: public IState
    {
        public:
            FadeInState (IState *nextState, uint32_t fadeTime = 300);
